package projetoSalf.mvc.service;
...
public class FornecedorService {
    ...
    public List<Map<String, Object>> getFornecedor(Conexao conexao) {
        List<Fornecedor> lista = Fornecedor.consultarTodos(conexao);
    ...
    public Map<String, Object> deletarFornecedor(int id, Conexao conexao) {
        Fornecedor fornecedor = Fornecedor.consultarPorId(id, conexao);
        if (fornecedor == null) {
            return Map.of("erro", "Fornecedor não encontrado");
        }

        boolean deletado = Fornecedor.deletar(fornecedor, conexao);
        if (deletado) {
    ...
    public Map<String, Object> addFornecedor(
            ...
            String complemento, String cnpj, String telefone, String contato, String email, Conexao conexao) {
        ...
        // Corrigir campos opcionais nulos
        ...
        Fornecedor gravado = novo.inserir(conexao);
    ...
    public Map<String, Object> updateFornecedor(
        ...
        Fornecedor existente = Fornecedor.consultarPorId(cod, conexao);
        if (existente == null) {
            return Map.of("erro", "Fornecedor não encontrado");
        }
        ...
        Fornecedor atualizado = existente.alterar(conexao);
