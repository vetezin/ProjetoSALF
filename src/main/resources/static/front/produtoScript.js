...
async function listarProdutos() {
  ...
  try {
    let response = await fetch("http://localhost:5050/apis/produto");
...
async function buscarPorCategoria() {
  ...
  try {
    let response = await fetch(
      `http://localhost:5050/apis/produto/categoria/${categoriaInput}`
    );
...
async function buscarPorValorMenor() {
  ...
  try {
    let response = await fetch(
      `http://localhost:5050/apis/produto/menor-que/${valor}`
    );
...
function cadastrarProduto(event) {
  ...
  fetch("http://localhost:5050/apis/produto", {
    method: "POST",
    headers: {
...
async function carregarCategorias() {
  ...
  try {
    let response = await fetch("http://localhost:5050/apis/categoria");
...
function apagarProduto(id) {
  ...
  fetch(`http://localhost:5050/apis/produto/${id}`, {
    method: "DELETE",
  })
    .then((response) =>
...
function atualizarProduto(event) {
  ...
  fetch(`http://localhost:5050/apis/produto?${dados.toString()}`, {
    method: "PUT",
  })
    .then((response) => response.json())
    .then((res) => {
...
async function editarProduto(id) {
  try {
    let response = await fetch(`http://localhost:5050/apis/produto/${id}`);
...
async function buscarPorNome() {
  ...
  try {
   let response = await fetch(`http://localhost:5050/apis/produto/busca-nome?termo=${encodeURIComponent(termo)}`);
...
async function ordenarPorNome() {
  ...
  try {
    let response = await fetch("http://localhost:5050/apis/produto/ordenados");
    let produtos = await response.json();
